 ...
 *
 * Никакого выключателя у него нет и не было: закрытый, он не работал бы
 * там, где его собираются щупать. Цена решения прямая — пока он жив, рейтинг перестаёт быть свидетельством:
