...
const SOCIAL_PROOF = [
  ...
  {
    quote:
      "Показал бригаде готовую модель — согласовали объём работ за один звонок.",
    name: "Анна, Пермь",
  },
  {
    quote:
      "Наконец понятно, зачем нужен угол ската — не за красоту, а по СНиПу.",
    name: "Дмитрий, Тюмень",
  },
];
              ...
              {STEPS.map((step, i) => (
                <Reveal key={step.n} index={i}>
                  <div className="border-t border-line pt-6">
                    <span className="font-display text-h3 text-cream-dim">
                      {step.n}
                    </span>
        ...
        <section id="pricing" className="border-t border-line">
          <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
            ...
            <p className="prose-measure mt-4 text-body-l text-cream-dim">
              Начните бесплатно и переходите на точную настройку, когда решите,
              что строите по-настоящему.
            </p>
            <div className="mt-12 grid gap-6 lg:grid-cols-2">
              <div className="surface-1 rounded-2xl border border-line p-8">
                ...
                <p className="mt-3 text-body-s text-cream-dim">
                  Как LEGO Duplo — крупные детали, чтобы быстро увидеть общий
                  образ дома.
                </p>
              ...
              <div className="ingot-edge rounded-2xl border bg-surface p-8">
                ...
                <p className="font-display ingot-text mt-2 text-h1 font-extrabold">
                  700 ₽
                  <span className="text-body-l text-cream-dim"> / мес.</span>
                </p>
                <p className="mt-3 text-body-s text-cream-dim">
                  Как LEGO Technic — точные размеры, слои материалов и готовая
                  спецификация для стройки.
                </p>
                <ul className="mt-8 space-y-3 text-body-s">
              ...
              {SOCIAL_PROOF.map((item, i) => (
                <Reveal key={item.name} index={i}>
                  <blockquote className="border-t border-line pt-6">
                    ...
                    <footer className="mt-4 text-body-s text-cream-dim">
                      {item.name}
                    </footer>
                  </blockquote>
                </Reveal>
