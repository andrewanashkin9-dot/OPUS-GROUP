  ...
  return (
    <div ref={boxRef} className="relative">
      <button
        ...
        className="relative flex h-10 w-10 items-center justify-center rounded-full border border-[var(--plate-edge)] text-white transition-colors hover:border-[var(--plate-edge-hi)]"
      >
        <svg
          viewBox="0 0 20 20"
          className="h-5 w-5"
