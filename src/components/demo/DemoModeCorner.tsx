 ...
 * в кабинет.
 *
 * Показывается всем вошедшим, без каких-либо условий: выключателя нет.
 * Значит, он виден и на боевом сайте — и любой, кто нажмёт «Модератор»,
 * им станет. Это осознанный выбор, а не недосмотр; убирается удалением
 * строки <DemoModeCorner /> в src/app/layout.tsx и этого файла.
 *
