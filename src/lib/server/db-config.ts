...
/**
 * Настроена ли база вообще.
 *
 * Вопрос, а не требование: не бросает исключение и не раскрывает значений.
 * Нужен там, где отсутствие базы — не поломка, а состояние окружения:
 * публичная страница обязана открыться и на стенде без PostgreSQL, а вот
 * что на ней написать, знает только она сама.
 */
